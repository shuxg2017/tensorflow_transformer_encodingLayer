...
5. Note: there are 2 classes, the code of EncoderLayers and EncoderModel are the same, but EncoderLayers inherits tf.keras.layers.Layer and EncoderModel inherits tf.keras.Model.
